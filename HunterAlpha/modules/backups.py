...
from HunterAlpha import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from HunterAlpha.__main__ import DATA_IMPORT
...
# from HunterAlpha.modules.rules import get_rules
import HunterAlpha.modules.sql.rules_sql as rulessql

# from HunterAlpha.modules.sql import warns_sql as warnssql
import HunterAlpha.modules.sql.blacklist_sql as blacklistsql
from HunterAlpha.modules.sql import disable_sql as disabledsql

# from HunterAlpha.modules.sql import cust_filters_sql as filtersql
# import HunterAlpha.modules.sql.welcome_sql as welcsql
import HunterAlpha.modules.sql.locks_sql as locksql
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("HunterAlpha{}.backup".format(chat_id), "w") as f:
    ...
    os.remove("HunterAlpha{}.backup".format(chat_id))  # Cleaning file
