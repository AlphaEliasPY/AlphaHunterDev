...
from HunterAlpha.__main__ import STATS, GDPR, TOKEN, USER_INFO
import HunterAlpha.modules.sql.userinfo_sql as sql
from HunterAlpha.modules.disable import DisableAbleCommandHandler
from HunterAlpha.modules.sql.global_bans_sql import is_user_gbanned
from HunterAlpha.modules.sql.afk_sql import is_afk, check_afk_status
from HunterAlpha.modules.sql.users_sql import get_user_num_chats
...
from HunterAlpha import telethn as HunterAlphaTelethonClient, SUDO_USERS, SUPPORT_USERS
...
def info(update: Update, context: CallbackContext):
    ...
    god_mode_level_present = False

    if user.id == OWNER_ID:
        text += "\n\nUser level: <b>God</b>"
        god_mode_level_present = True
...
def gdpr(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not HunterAlpha data. "
