...
import HunterAlpha.modules.sql.welcome_sql as sql
import HunterAlpha
...
from HunterAlpha.modules.helper_funcs.misc import build_keyboard, delete, revert_buttons
from HunterAlpha.modules.helper_funcs.msg_types import get_welcome_type
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if new_mem.id == bot.id and not HunterAlpha.ALLOW_CHATS:
